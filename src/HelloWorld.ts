...
export class HelloWorldPanel {
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const stylesResetUri = webview.asWebviewUri(styleResetPath); //url to this file reset.css
    const stylesMainUri = webview.asWebviewUri(stylesPathMainPath);//url to this file vscode.css
    ...
    <link href="" rel="stylesheet">
             ...
             <body>
              ...
              <script src="${scriptUri}" nonce="${nonce}" defer> </script>
			</body>
			</html>`;
  }
